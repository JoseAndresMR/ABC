...
class UnityEpisodicEnvironment(Environment):
    ...
    def __init__(self, file_path: str, id: str, log_path: str):
        ...
        self.env_info = {"num_agents": self.num_agents, "state_size": state_size,
                         "state_type": state_type, "action_size": action_size, "action_type": action_type}
    ...
    def start_episodes(self, n_episodes=10000, max_t=3000, success_avg=30, print_every=3):
        ...
        self.e_scores = np.zeros(self.num_agents)
        return self.states
    ...
    def step(self):
        ...
        if self.current_t < self.max_t:
            ...
            # execute the selected actions and save the new information about the environment
            ...
            # check whether episodes have finished
