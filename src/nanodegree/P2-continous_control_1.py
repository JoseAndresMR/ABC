...
env = UnityEnvironment(file_name='/home/jamillan4i/Libraries/ABC/bin/environments/Reacher_1/Reacher.x86_64')
...
def ddpg(n_episodes=1000, max_t=3000, print_every=25):
    ...
    for i_episode in range(1, n_episodes+1):
        ...
        e_scores = np.zeros(1)  # the scores of an episode for each of the 20 reachers
        agent.reset()
